...
class YouTubeTest < Test::Unit::TestCase
  ...
  def test_transform_with_thumbnail
    ...
    assert_equal '<a class="youtube-thumbnail" href="#open_video"><img src="http://img.youtube.com/vi/BwNrmYRiX_o/default.jpg" alt="BwNrmYRiX_o"/><span class="youtube-icon"></span></a><iframe class="youtube-player" type="text/html" width="390" height="250" src="http://www.youtube.com/embed/BwNrmYRiX_o" frameborder="0">
</iframe>', result
  end
end
